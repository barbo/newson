		...
		{	
			...
			else
			{
				...
				{	
					...
					$errors[] = $_SESSION['lang']["FORGOTPASS_NEW_PASS_EMAIL"];
				}
			}
		}
	}
...
if(!empty($_GET["deny"]))
{
	...
	else
	{
		...
		$errors[] = $_SESSION['lang']["FORGOTPASS_REQUEST_CANNED"];
	}
}
...
if(!empty($_POST))
{
	...
	if(count($errors) == 0)
	{
		...
		else
		{
			...
			{
				$errors[] = $_SESSION['lang']["FORGOTPASS_REQUEST_EXISTS"];
			}
			else
			{
				...
				else
				{
					...
					else
					{
						...
						$successes[] = $_SESSION['lang']["FORGOTPASS_REQUEST_SUCCESS"];
					}
				}
			}
		}
...
<div id='content'>
<h1>My Form</h1>
<h2>".$_SESSION['lang']['Forgot_Pass']."</h2>
<div id='left-nav'>";
